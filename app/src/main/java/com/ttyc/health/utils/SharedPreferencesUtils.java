...
public class SharedPreferencesUtils {
    private static final String SP_NAME="HEALTH.TTYC";
    private static final String GUID_FLAG="GUID_FLAG";
    public static void putGuidFlag(Context context,boolean flag){
        SharedPreferences sharedPreferences = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        sharedPreferences.edit().putBoolean(GUID_FLAG,flag).commit();
    }

    public static boolean getGuidFlag(Context context){
        SharedPreferences sharedPreferences = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
       return  sharedPreferences.getBoolean(GUID_FLAG,false);
    }
