...
public class DealCardsActivity extends BaseActivity {
    private static String TAG= DealCardsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinCount=getIntent().getIntExtra("cards",0);
        initView();
    }

    private void initView(){
        setTitle("消费卡交易");
        ((ImageView)findViewById(R.id.iv)).setImageDrawable(getDrawable(R.drawable.cards_h256));
    }
    public void deal(View view){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                String urls = Constants.URL_DEAL_CARDS;
                String param = "phone=" + MyApplication.phone + "&pwd=" + pwd+"&uid="+uid+"&cards="+coinCount; // 请求参数
                String data; // 返回结果
                Message msg; // 信息类
